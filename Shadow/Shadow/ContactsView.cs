...
namespace Shadow
{
	public class ContactsView : ContentView
	{
		...
		public static ContactsView ContactsViewInstance;
		...
		public ContactsView ()
		{
			...
			var temp = new DataTemplate(typeof(contactTextViewCell));
							...
							new StackLayout {
								...
								Children = {
									new Label {
										...
										VerticalOptions = LayoutOptions.FillAndExpand,
										Text = "Contacts on this list will receive the Emergency message you created as well as your GPS coordinates, when you press the panic button",
	...
	public class contactTextViewCell : ViewCell
	{
		public contactTextViewCell()
		{
		...
		{
			ContactsView.ContactsViewInstance.OpenContactPicker();
		}

		void OnDelete(object sender, EventArgs e)
		{
			var item = (MenuItem)sender;
			ContactsView.ContactsViewInstance.RemoveContact(item.CommandParameter.ToString());
		}
	}
}
