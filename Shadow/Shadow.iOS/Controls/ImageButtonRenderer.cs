...
namespace Shadow
{
    ...
    public partial class ImageButtonRenderer : ButtonRenderer
    {
        ...
        /// </summary>
        private const int CONTROL_PADDING = 10; // was 2
        ...
        protected override async void OnElementChanged(ElementChangedEventArgs<Button> e)
        {
            ...
            if (imageButton != null && targetButton != null && imageButton.Image != null)
            {
        ...
        async Task SetupImages(ImageButton imageButton, UIButton targetButton, int width, int height)
        {
            ...
            await SetImageAsync(imageButton.Image, width, height, targetButton, UIControlState.Normal, tintColor);

            if (imageButton.DisabledSource != null || disabledTintColor != null)
            {
                await SetImageAsync(imageButton.DisabledSource ?? imageButton.Image, width, height, targetButton, UIControlState.Disabled, disabledTintColor);
            }
        }
